...
define("DB_USER", 'root');
define("DB_PASSWORD", '');
define("DB_NAME", 'fusaviajes');
define("DB_HOST", '127.0.0.1');
define("BACKUP_DIR", 'Backup-BD'); // Comment this line to use same script's directory ('.')
define("BACKUP_FILE", 'myphp-backup-fusaviajes-20200510_160624.sql.gz'); // Script will autodetect if backup file is gzipped based on .gz extension
define("CHARSET", 'utf8');
...
header("Location: https://fusaviajes.test/admin/configuracion");
