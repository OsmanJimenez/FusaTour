  ...
  <main class="app__layout-content"><video autoplay></video><!-- Dialog  -->
    <div class="app__dialog app__dialog--hide">
      <div class="app__dialog-content">
        <h5>FusaTour QR</h5><input type="text" id="result">
      </div>
      <div class="app__dialog-actions"><button type="button" class="app__dialog-close">Cerrar</button> <button type="button" class="app__dialog-open">Vamos</button></div>
    </div>
...
<script type="text/javascript" src="main.84fafbea08addfebc92f.bundle.js"></script>
