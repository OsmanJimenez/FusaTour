            ...
            <div class="col s12">
                ...
                <div class="col s12 pad-0">
                    ...
                    <a-scene light="defaultLightsEnabled: false" shadow="type=pcfsoft" style="height: 300px;
                        ...
                        <!--North Wall Pictures-->
                        <a-entity geometry="primitive: box; depth: 0.2; height:10; width: 30" position="0 5 10" material="src: url(/images/images/wall.jpg); repeat: 30 10; metalness: 0; roughness: 1">
                        </a-entity>

                        <a-text value="Mural Salvaje" aling="center" color="#fff" position="-3.9 6 -9.5" scale="6.4 9.3 8.9">
                        </a-text>

                        <a-text value="Autor:Macondian" aling="center" color="#fff" position="-2.2 3.7 -9.5" scale="2.6 2.4 4.1">
                        </a-text>
                        ...
                        <!--Window in East Wall -->
                        <a-entity geometry="primitive: box; depth: 17.5; height: 7.5; width: 0.1" position="15 5 0" material="src: url(/images/images/Mural_Salvaje.jpeg)">
                        </a-entity>
                        ...
                        <!--Picture -->
                        <a-entity geometry="primitive: box; depth: 7; height: 0.1; width: 6.6" position="7 5 9.9" material="src: url(/images/images/Mural_Salvaje_2.jpeg)" ) rotation="270 180 0">
                        </a-entity>

                        <a-entity geometry="primitive: box; depth: 7; height: 0.1; width: 6.6" position="-3 5 9.9" material="src: url(/images/images/Mural_Salvaje_3.jpeg)" ) rotation="270 180 0">
                        </a-entity>
                    </a-scene>
                    @endif
